...
<div class="colgnrl">
 <a href="/reservation" class="col1"><img src="{{ asset('image/reservation.png') }}" alt="secretaire" width="200" height="200" class="">
   <p>Reservation</p></a>
 <a href="/reserve" class="col2"><img src="{{ asset('image/liste.png') }}" alt="secretaire" width="200" height="200" class="">
   <p>Status de reservation</p></a>
 </div>
 @if(session('status'))
